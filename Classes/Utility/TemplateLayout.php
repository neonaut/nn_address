...
class TemplateLayout implements SingletonInterface
{
    ...
    protected function getTemplateLayoutsFromTsConfig($pageUid)
    {
        ...
        if (isset($pagesTsConfig['tx_nnaddress.']['templateLayouts.']) && is_array($pagesTsConfig['tx_nnaddress.']['templateLayouts.'])) {
            $templateLayouts = $pagesTsConfig['tx_nnaddress.']['templateLayouts.'];
        }
        return $templateLayouts;
    }
}
